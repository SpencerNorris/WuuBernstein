...
class Mailbox:
    def __init__(self):
        ...
        self.server.bind((self.client_ip, self.client_port))
        self.server.listen(20) 
        print("Mailbox listening on {}:{}".format(self.client_ip,self.client_port))
    ...
    def __handle_req(self,client_sock):
        ...
        def __handle_view(self,buff_size):
            ...
            self.server.connect(self.client_ip,self.server_port)
            self.server.send("1")
        ...
        msg_type =     self.client_sock.recv(38).decode()
